...
type User struct {
	...
	Password    string `gorm:"not null" json:"password" binding:"-"`                                          // 密码哈希，不进行JSON序列化和绑定
	Avatar      string `gorm:"default:'https://avatars.githubusercontent.com/u/107172084?v=4'" json:"avatar"` // 头像链接，默认为用户.svg
